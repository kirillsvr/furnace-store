...
(function( window, undefined ) {
	...
	wp.api.utils.addMixinsAndHelpers = function( model, modelClassName, loadingObjects ) {
		...
		var hasDate = false,
			 ...
			 * to or from the server. For example, a date stored as `2021-12-27T21:22:24` on the server
			 * gets expanded to `Sun Dec 27 2021 14:22:24 GMT-0700 (MST)` when the model is fetched.
			 *
