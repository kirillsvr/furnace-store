                        ...
                        <div class="woof_submit_search_form_container">
                            ...
                            <?php if ($this->is_isset_in_request_data($this->get_swoof_search_slug())): global $woof_link; ?>
                                ...
                                <?php if ($woof_reset_btn_txt != 'none'): ?>
                                    <button style="float: right;" class="button woof_reset_search_form" data-link="<?php echo $woof_link ?>">Сбросить</button>
                                <?php endif; ?>
                            <?php  endif; ?>
                            ...
                            <?php if (!$autosubmit OR $ajax_redraw): ?>
                                ...
                                ?>
                                <button style="float: left;" class="button woof_submit_search_form">Фильтр</button>
                            <?php endif; ?>
