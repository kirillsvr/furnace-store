...
if ( !class_exists( 'YIT_Theme_Licence' ) ) {
    ...
    class YIT_Theme_Licence extends YIT_Licence {
        ...
        /**
         * @var string Old theme licence works until 28 January 2021
         * @since 1.0
         */
        protected $_old_licence_expires = 1453939200; //28 January 2021
        ...
        public function get_old_licence_message() {
            ...
            <div class="activation-faq">
                ...
                <p>
                    <?php
                    _e( 'If you have purchased one of our products before 27 January 2021, you can benefit from support and updates (the services offered with the license)
                    until 27 January 2021 and you do not have to purchase it again to get a new license key, because, before this date, your license used to be activated automatically by our system.
                    After 27 January 2021, instead, if you want to benefit from support and updates you have to buy a new license and activate it through the license key you will be
