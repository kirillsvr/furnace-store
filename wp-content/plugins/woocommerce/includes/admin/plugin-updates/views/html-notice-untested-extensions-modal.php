...
<div id="wc_untested_extensions_modal">
	<div class="wc_untested_extensions_modal--content">
		...
		<div class="wc_plugin_upgrade_notice extensions_warning">
			...
			<p><?php esc_html_e( 'As this is a major update, we strongly recommend creating a backup of your site before updating.', 'woocommerce' ); ?> <a href="https://woocommerce.com/2021/05/create-use-backups-woocommerce/" target="_blank"><?php _e( 'Learn more', 'woocommerce' ); ?></a></p>
