                    ...
                    foreach ($brands as $brand) {
                        ...
                        echo '<li class="'. $li_class .'">';
                          if( $display_as == 'brand_logo' && !empty( $brand_logo ) ){
							...
							echo '<a href="'.$brand_link.'" title="'.__( 'Go to', 'perfect-woocommerce-brands' ).' '.$brand->name.'" class="brand-name">'.$brand->name.'</a>';
							echo '<div class="brand-desc">'.$brand->description.'</div>';
                          }else{
