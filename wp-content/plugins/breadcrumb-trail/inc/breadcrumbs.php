...
class Breadcrumb_Trail {
	...
	protected function set_labels() { 
		...
		$defaults = array(
			'browse'              => esc_html__( '',                               'breadcrumb-trail' ),
			'aria_label'          => esc_attr_x( 'Breadcrumbs', 'breadcrumbs aria label', 'breadcrumb-trail' ),
			'home'                => esc_html__( 'Главная',                                  'breadcrumb-trail' ),
			'error_404'           => esc_html__( '404',                         'breadcrumb-trail' ),
			'archives'            => esc_html__( '',                              'breadcrumb-trail' ),
			// Translators: %s is the search query.
			'search'              => esc_html__( 'Поисковые результаты: %s',                'breadcrumb-trail' ),
