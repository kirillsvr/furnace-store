...
function twentyfifteen_setup() {
	...
	register_nav_menus( array(
		...
		'secondary'  => __( 'Secondary Links Menu', 'twentyfifteen' ),
		'sidemenu'  => __( 'Article Side Menu', 'twentyfifteen' ),
	) );
...
function twentyfifteen_add_woocommerce_support() {
	add_theme_support( 'woocommerce' );
}
add_action( 'after_setup_theme', 'twentyfifteen_add_woocommerce_support' );
...
function twentyfifteen_widgets_init() {
	...
	register_sidebar( array(
		'name'          => __( 'Главная страница - производители', 'twentyfifteen' ),
		'id'            => 'home-brands',
		'description'   => __( '', 'twentyfifteen' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h2 class="widget-title">',
		'after_title'   => '</h2>',
	...
	register_sidebar( array(
		'name'          => __( 'Каталог - фильтр', 'twentyfifteen' ),
		'id'            => 'sidebar-shop',
		'description'   => __( '', 'twentyfifteen' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
...
function twentyfifteen_scripts() {
	...
	wp_enqueue_script( 'twentyfifteen-script', get_template_directory_uri() . '/js/functions.js', array( 'jquery' ), '20210330', true );
...
add_image_size( 'medium_large', '768', '0', false );
add_image_size( 'post-thumbnail', '825', '510', true );
...
add_image_size( 'slider', '870', '400', true );
add_image_size( 'slider-side', '280', '190', true );
add_image_size( 'cattemimg', '270', '220', true );
add_image_size( 'reviews', '115', '147', true ); 
...
function my_theme_woocommerce_taxonomy_archive_description($category) {
    ...
    echo '<div class="subterm-description">' . category_description( $category_id ). '</div>';
}
